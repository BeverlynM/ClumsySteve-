game.BirdEntity = me.Entity.extend({
    ...
    onCollision: function(response) {
        ...
        if (obj.type === 'hit') {
            ...
            game.data.steps++;
            if (game.data.steps >= parseInt(document.getElementById("max_steps").value)) {
	            this.collided = true;
            }
            me.audio.play('hit');
        }
...
game.PipeGenerator = me.Renderable.extend({
    init: function() {
        ...
        this.pipeHoleSizeOrig = 1370;
        this.pipeHoleSize = 1370; // orig: 1240;
        this.pipeHoleSizeOrig = this.pipeHoleSize;
        this.pipeHoleSizeSm = 1140; // EN1 new value
    ...
    update: function(dt) {
        if (this.generate++ % this.pipeFrequency == 0) {
            ...
            this.pipeHoleSize = this.pipeHoleSize - (this.pipeHoleSizeOrig - this.pipeHoleSizeSm) / (parseInt(document.getElementById("max_steps").value));
